...
procedure Match_Times is
   ...
   OEM_00           : constant String := Spyder_Directory & "OEM_00.csv";
   OEM_01           : constant String := Spyder_Directory & "OEM_10.csv";
   OEM_10           : constant String := Spyder_Directory & "OEM_01.csv";
   OEM_11           : constant String := Spyder_Directory & "OEM_11.csv";
