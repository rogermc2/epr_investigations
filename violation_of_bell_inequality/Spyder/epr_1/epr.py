...
data.info()
data["A Arrival Shifted"].hist()
data["B Arrival Time"].hist()
# %%
data["A Arrival Time"].describe()
# %%
data["B Arrival Time"].describe()
# %%
Arrival_Times = data[["A Arrival Time","B Arrival Time"]].round(12)
...
print()
print ("A10-B5", (data.at[10, 'A Arrival Time'] - data.at[5, 'B Arrival Time']).round(12))
print ("A11-B5", (data.at[11, 'A Arrival Time'] - data.at[5, 'B Arrival Time']).round(12))
print ("A12-B5", (data.at[12, 'A Arrival Time'] - data.at[5, 'B Arrival Time']).round(12))
print ("A9996-B7552", (data.at[9996, 'A Arrival Time'] - data.at[7552, 'B Arrival Time']).round(16))
print ("A9997-B7552", (data.at[9997, 'A Arrival Time'] - data.at[7552, 'B Arrival Time']).round(16))
print ("A9998-B7552", (data.at[9998, 'A Arrival Time'] - data.at[7552, 'B Arrival Time']).round(16))
